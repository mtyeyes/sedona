...
gulp.task("jsIndex", function() {
  return gulp.src(["source/js/menu.js", "source/js/map.js", "source/js/picturefill.min.js", "source/js/svg4everybody.js"])
...
gulp.task("scripts", gulp.series("jsIndex", "jsForm", "jsPhoto"));
